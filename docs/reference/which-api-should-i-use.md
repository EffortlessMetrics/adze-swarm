...
| --- | --- | --- |
| Generate starter project | `adze init` output | `cargo test -p adze-cli test_init_default_cwd_generates_buildable_project -- --exact --nocapture`; `cargo test -p adze-cli test_init_generates_buildable_project -- --exact --nocapture` |
